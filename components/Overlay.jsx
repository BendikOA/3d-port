    ...
    <Scroll html>
      <div class="w-screen">
        ...
        <Section opacity={opacityThirdSection}>
          ...
          <div className="inline-flex items-center mt-2  justify-center font-gameboy ml-1">
            <Link href="bendikoa_cv.pdf" target="_blank">

              <button class="mr-1 md:mr-4 bg-[#e4e4e4] hover:bg-[#052564] text-[#052564] font-semibold hover:text-[#e4e4e4] py-2 px-4 border border-[#B4C6E140] hover:border-transparent rounded">
                CV</button>
              <Link href="nettsider">
