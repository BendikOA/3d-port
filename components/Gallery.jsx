...
const Gallery = () => {
  return (
    <div>
        <div className="py-10 pb-20 md:px-20 lg:px-40 bg-gradient-to-r from-[#fbab7e] to-[#f7ce68]" id="3d" >
        ...
        <div className="px-10 flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap ">
            <div className="basis-1/3 flex-1 object-cover" data-aos="fade-up">
              <Image className="rounded-md shadow-lg shadow-black" src={w1} width={"100%"} />
            </div>
            <div className="basis-1/3 flex-1 object-cover" data-aos="fade-up" data-aos-delay="100">
              <Image className="rounded-md shadow-lg shadow-black" src={w2} width={"100%"} />
            </div>
          </div>
          
          <div className="px-10 flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            <div className="basis-1/6 flex-1 object-cover" data-aos="fade-up" data-aos-delay="200">
              <Image className="rounded-md shadow-lg shadow-black" src={vert1} width={"100%"} />
            </div>
            <div className="basis-1/6 flex-1 object-cover" data-aos="fade-up" data-aos-delay="300">
              <Image className="rounded-md shadow-lg shadow-black" src={vert2} width={"100%"} />
            </div>
            <div className="basis-1/6 flex-1 object-cover mx-auto" data-aos="fade-up" data-aos-delay="400">
              <Image className="rounded-md shadow-lg shadow-black" src={vert3} width={"100%"} />
            </div>
            <div className="basis-1/6 flex-1 object-cover" data-aos="fade-up" data-aos-delay="500">
              <Image className="rounded-md shadow-lg shadow-black" src={vert4} width={"100%"} />
            </div>
        </div>
        </div>
    </div>
